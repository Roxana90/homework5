...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '-i',
        '--input_type',
        help=f'Type of file where we read from. Available types: {AVAILABLE_FILE_TYPES}.',
        dest='input_type',
        default='csv',
    )
    parser.add_argument(
        '-o',
        '--output_type',
        help=f'Type of file where we write top. Available types: {AVAILABLE_FILE_TYPES}.',
        dest='output_type',
        default='json'
    )
